    ...
    if uploaded_files:
        ...
        while not success and retries > 0:
            try:
                ...
                - "Premium Amount": Read the handwritten Bengali numerals carefully, along with commas (if given). Pay very close attention to the Bengali digit '১' (1). It is often misread as '২' (2) because of the comma following it (e.g., '১,০০০/-' being misread as '২,০০০/-'). Ensure you distinguish between '১' and '২' accurately based on the initial stroke. Do not add zeroes.
